...
const LoginModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // FIX: Use the Vite environment variable for the API base URL
    const apiBaseUrl = import.meta.env.VITE_API_BASE_URL;

    try {
      // 1. Make the API call to your backend with the FULL URL
      ...
      // 2. If successful, call the login function from the context
      login(token);
